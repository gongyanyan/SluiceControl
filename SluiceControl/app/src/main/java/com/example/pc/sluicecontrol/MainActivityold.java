                ...
                case 1:   //扇门
                    ...
                    if(recLen <= 0){     //isThough为true 人已经通过扇门，扇门关闭
                        ...
                        if(modeXMLBean.getType().equals("进站从机")||modeXMLBean.getType().equals("出站从机")){  //如果是从机，则需要告诉主机，线程已经结束
                                ...
                                ParamsBean2 setBean = new ParamsBean2(modeXMLBean.getType(),"从机循环结束","chen",22,IpAndress,90,"0139");
            ...
            public void onOpenDoor(String param) {
                ...
                if(paramsBean.getMsgType().equals("FaceRecognitionResult")){   //执行开门命令
                    ...
                    if(modeXMLBean.getType().equals("进站主机")||modeXMLBean.getType().equals("出站主机")){
                        ...
                        ParamsBean2 setBean = new ParamsBean2(modeXMLBean.getType(),"white","chen",22,IpAndress,90,"0139");
                        String json = JSONObject.toJSONString(setBean);
                        postString("http://172.16.0.111:8082/",json);   //主机的地址
                        isOpenDoor = true;
                    }
                    ...
                    SlaveIpAndress = paramsBean.getUserID();  //得到从机的IP地址
                    isThough = false;
...
//        serialPort.sendBuffer(messageTan.getBtAryTranData());
    ...
    public String type(String isA){

        if(isA.equals("CNTA")){
            type= "01";   //进站
        }else if(isA.equals("CNTB")){
            type="02";  //出站
        }
        return type;
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case  R.id.image:
                ...
                Intent intent = new Intent(MainActivityold.this,RepairTetsActivty.class);
